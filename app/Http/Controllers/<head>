...
<body>
    <div class="container">
        <div class="container">
            ...
            <form method="POST" action="http://wakprint.test/pdf" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="O29022D9Cr7vWVXGyyxHiv6a661gVcmvDkR9QmpL">                <div class="form-group">
    ...
    <script>
        ...
        $("#buttonno1").click(function(){
            document.getElementById('loadarea_show').src = "http://wakprint.test/php/progressbar_val.php";
        });
