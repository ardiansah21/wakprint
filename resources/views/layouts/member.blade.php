                                ...
                                <div class="bg-light-purple text-center"
                                    ...
                                    @else
                                        <img src="https://unsplash.it/600/400" class="img-responsive" alt="" width="300px"
                                            ...
                                            style="border-radius:8px; object-fit:cover;">
                                    @endif
                                    <div class="bg-dark pl-2 pr-2" style="position: relative; top: -17%; left: 50%; transform: translate(-50%, 0%); opacity:80%; color: white; width:300px; border-radius:0px 0px 8px 8px;">
                                        <label class="font-weight-bold text-truncate my-auto mx-auto" style="font-size: 28px; width:100%;">{{ $member->nama_lengkap }}</label>
                                    </div>
                                </div>
                                <div class="mt-3">
