                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item mr-2" style="display: flex; align-items:center;">
                                <a class="nav-link SemiBold" href="#" style="color: black; font-size: 24px;">{{ __('Chat') }}</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-3">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <img src="{{url('img/facebook.png')}}" class="img-responsive ml-4" alt="" width="24" height="24">
                                    <img src="{{url('img/youtube.png')}}" class="img-responsive ml-4" alt="" width="24" height="24">
                                    <img src="{{url('img/whatsapp.png')}}" class="img-responsive ml-4" alt="" width="24" height="24">
                                </div>
                                <div class="row">
                                    <a>
                                        <i class="fa fa-copyright" style="font-size: 16px;">{{__(' Copyright Wakprint 2020') }}</i>
                                    </a>
                                </div>
                        </div>
                    </div>
