                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link {{ request()->is('admin') ? 'active' : '' }} active mb-2"
                            ...
                            <a class="nav-link {{ request()->is('admin/member') ? 'active' : '' }} mb-2"
                            ...
                            <a class="nav-link mb-2" id="v-pills-data-pengelola-tab" href="{{ route('admin.partner') }}"
                            ...
                            <a class="nav-link mb-2" id="v-pills-saldo-tab" href="{{ route('admin.saldo') }}" role="tab"
                            ...
                            <a class="nav-link mb-4" id="v-pills-keluhan-tab" href="{{ route('admin.keluhan') }}"
