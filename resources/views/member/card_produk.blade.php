...
<div class="card shadow cursor-pointer mb-2" style="border-radius: 10px;">
    {{-- <a class="text-decoration-none"
        ...
        <img class="card-img-top cursor-pointer"
            ...
            @endif
            onclick="window.location.href='{{ route('detail.produk', $p->id_produk) }}'" style="height: 180px; object-fit:cover; border-radius: 10px 10px 0px 0px;" alt="Terdapat Kesalahan Penampilan Foto"/>
