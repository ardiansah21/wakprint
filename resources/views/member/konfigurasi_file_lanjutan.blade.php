...
<div class="container">
    <div class="mt-5 mb-5">
        ...
        <div class="row justify-content-between bg-light-purple pl-4 pr-4 pt-4 pb-4 mt-5 mb-5 mr-0 ml-0" style="border-radius:5px; height:310px;">
    ...
    <div id="detailProduk" hidden>
        ...
        <label class="font-weight-bold" style="font-size:36px;">{{__('Produk') }}
        </label>
        <div class="bg-light-purple p-4 mb-4" style="border-radius:5px; min-height:300px; position: relative;">
            <div class="text-center" style="position: absolute; top: 50%; left:33%; -ms-transform: translateY(-50%); transform: translateY(-50%);">
                <button class="btn btn-primary-wakprint font-weight-bold pl-4 pr-4" style="border-radius:30px; font-size:24px;">
                ...
                <div class="col-md-8">
                    <div class="ml-2">
                        <div class="text-right">
                            <button class="btn btn-primary-yellow btn-rounded font-weight-bold py-1 px-4 mb-4" style="border-radius:35px;font-size: 16px;" onclick="openDialog()">
                                {{__('Ubah Produk') }}
                            </button>
                        </div>
                        <br>
                ...
                <table class="table table-hover text-center" style="border-radius:25px 25px 15px 15px;">
                    <thead class="bg-primary-purple text-white align-self-center">
                        <tr style="font-size: 18px;">
                            ...
                            <th class="align-middle" scope="col-md-auto">{{__('Persentase kandungan Berwarna') }}</th>
        ...
        <div class="row justify-content-between ml-0 mr-0 mt-2 mb-5">
            <div class="form-group mb-3 mr-2">
                <button class="btn btn-outline-danger-primary font-weight-bold pl-4 pr-4" style="border-radius:30px;
                        font-size:24px;">
