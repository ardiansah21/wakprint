                        ...
                        <div class="col-md-10">
                            <div class="row justify-content-between">
                                <div class="col-md-auto">
                                    <a class="text-truncate mb-0" href="#" style="font-size: 24px;">
                                        {{$namafile}}
                                    </a>
                                    <br>
                                ...
                                <div class="col-md-auto align-self-center mr-0">
                                    <button
                                        class="btn btn-primary-yellow btn-rounded font-weight-bold ml-5 pt-1 pb-1 pl-4 pr-4"
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row justify-content-left mb-4">
                            <div class="col-md-auto">
                                <img src="{{ url('img/buka.png') }}" class="align-self-center img-responsive mt-2"
                        ...
                        <div class="row justify-content-left ml-0 mb-4">
                            <img src="https://ptetutorials.com/images/user-profile.png" width="50" height="50"
                                alt="no logo">
