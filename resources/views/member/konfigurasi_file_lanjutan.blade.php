...
@section('content')
    <div class="mt-5 mb-5">
        <label class="font-weight-bold"
            style="font-size:48px;">{{__('Konfigurasi File') }}
        </label>
        <div class="row justify-content-between mb-5">
            <div class="col-md-auto mt-5 mr-0">
                <div class="border-primary-purple"
                    ...
                    <div class="row bg-dark justify-content-between align-middle ml-0 mr-0 pl-2 pr-2 pt-4 pb-4" 
            ...
            <div class="col-md-6 mt-5">
                <div class="bg-light-purple mb-4" style="border-radius:5px;">
                    <div class="row justify-content-left pl-3 pr-3 pt-3 pb-3">
                        <div class="text-center align-self-center col-md-auto mr-0">
                        ...
                        <div class="col-md-10">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-md-auto align-self-center mr-0">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-7">
                        <label class="mb-0"
                            ...
                            {{__('16 Halaman Hitam Putih') }}
                        </label>
                        <br>
                        <label class="mb-2"
                            style="font-size: 18px;">
                            {{__('6 Halaman Berwarna') }}
                        </label><br>
                        ...
                        <div class="form-group custom-control custom-radio mb-4"
                            ...
                            <br>
                            <input type="text mr-4"
                                class="form-input">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <label class="card-title font-weight-bold mb-4"
                            style="font-size: 24px;">
                            {{__('Jumlah Salinan') }}
                        </label>
                        ...
                        <div class="form-group custom-control custom-checkbox mt-2 ml-0"
                            style="font-size: 18px;">
                            <input type="checkbox"
                                class="custom-control-input"
                                id="checkboxTimbalBalik">
                            <label class="custom-control-label"
                                for="checkboxTimbalBalik">
                                {{__('Timbal Balik') }}
                            </label>
                        </div>
                        <div class="form-group custom-control custom-checkbox mt-2 ml-0"
                            ...
                            <input type="checkbox"
                                class="custom-control-input"
                                id="checkboxPaksaHitamPutih">
                            <label class="custom-control-label"
                                for="checkboxPaksaHitamPutih">
        ...
        <div class="bg-light-purple pt-3 pb-3 pl-4 pr-4 mb-4 ml-0"
        ...
        <div class="border-primary-purple my-custom-scrollbar-2 p-5 mb-5"
            style="border-radius:5px;">
            <div class="card shadow mt-0 ml-0 mb-4 p-4">
                <div class="row justify-content-between">
                    <div class="col-md-8">
                        ...
                        <label class="text-truncate-multiline mb-4"
                            style="font-size: 18px;">
                ...
                <div class="row justify-content-between">
                    <div class="col-6">
                        ...
                        <div class="row justify-content-center mb-5">
                            ...
                            <!--Carousel Wrapper-->
                            <div id="multi-item-foto-produk" 
                                class="col-md-9 carousel slide carousel-multi-item"
                                data-ride="carousel">
                        ...
                        <div class="bg-light-purple p-4 mb-4"
                            style="border-radius:5px;
                                font-size: 18px;">
                            <label class="mb-2">
                                {{__('Harga Produk') }}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row justify-content-left mb-4">
                            <div class="col-md-auto">
                                <img src="{{ url('img/buka.png') }}"
                                    class="align-self-center img-responsive mt-2"
                                    alt=""
                                    width="100px"
                                    height="50px">
                            </div>
                            ...
                            <div class="col-md-auto mb-2">
                                <div class="row justify-content-between">
                                    <label class="col-md-auto SemiBold mr-4"
                                        style="font-size: 18px;">
                                    ...
                                    <label class="col-md-auto text-right align-self-center"
                                        style="font-size: 14px;">
                                        <a class="text-primary-purple" 
                                            href="{{ url('member/ulasan-produk') }}">
                                            {{__('Ulasan')}}
                                        </a>
                                    </label>
                                </div>
                        ...
                        <div class="row justify-content-left ml-0 mb-4">
                            <img src="https://ptetutorials.com/images/user-profile.png" 
                                ...
                                height="50"
                                alt="no logo">
                            <label class="align-self-center font-weight-bold mb-0 ml-4"
                                style="font-size: 18px;">
                                {{__('Ali Susi') }}
                            </label>
                        </div>
                        <div class="card shadow-sm pl-4 pr-4 pt-2 pb-2 mb-4"
                            style="font-size: 18px;">
                            <p class="card-text">
                        ...
                        <div class="text-right mb-0">
                            <button class="btn btn-primary-yellow font-weight-bold pl-4 pr-4"
                                style="border-radius:30px;
        ...
        <div class="row mr-0 mb-5">
            <div class="col-md-6 pl-2 pr-4 pb-4 pt-4 mb-4" 
                style="border-radius:5px;">
            ...
            <div class="col-md-6 bg-light-purple pl-4 pr-4 pt-2 pb-2 mt-4 mr-0"
        ...
        <div class="row justify-content-end ml-0 mr-0 mb-5">
            <div class="form-group mb-3 mr-4">
                <button class="btn btn-outline-purple font-weight-bold pl-4 pr-4"
                style="border-radius:30px;
                font-size:24px;">
