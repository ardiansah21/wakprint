<div class="card shadow-sm mb-3 pl-4 pr-2" style="border-radius: 10px;">
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="card-body">
                <h5 class="card-title text-truncate SemiBold mb-1" style="font-size: 24px;">{{__('Cetak Hitam Putih Dokumen') }}</h5>
                <label class="card-text text-truncate mb-2" style="font-size: 18px;">{{__('Toko Uwak') }}</label>
