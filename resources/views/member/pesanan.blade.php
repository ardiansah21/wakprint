                ...
                <div class="mt-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="mt-3">
                            ...
                            <a class="nav-link active" id="v-pills-pesanan-tab" onclick="window.location='{{ url('/member/pesanan') }}'" data-toggle="pill" href="#v-pills-pesanan" role="tab" aria-controls="v-pills-pesanan" aria-selected="false"><i class="material-icons align-middle md-32 mr-2">shopping_cart</i>Pesanan</a>
                        </div>
            ...
            <div class="container col-md-8 mt-5">
                ...
                <div class="row mb-3 ml-0">
                    <div class="container col-auto">
                        <div class="dropdown">
                            <button class="btn btn-default btn-lg shadow-sm dropdown-toggle border border-gray" type="button" id="dropdownMenuButton" 
                    ...
                    <div class="container col-9">
                        <div class="input-group mb-3" role="search">
                            <input type="text" class="form-control form-control-lg shadow-sm" placeholder="Cari percetakan atau produk disini"
