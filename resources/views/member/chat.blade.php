                ...
                <div class="my-custom-scrollbar mb-0">
                    ...
                    <div class="row justify-content-between mb-4">
                        ...
                        <div class="col-md-auto">
                            <label class="d-inline-block text-truncate SemiBold mb-0" style="font-size:18px; max-width: 170px;">{{__('Ali Susi')}}</label>
                            <br>
                            <label class="d-inline-block text-truncate mb-0" style="font-size:14px; max-width: 170px;">{{__('Apa cerita kita hari')}}</label>
                        </div>
                ...
                <div class="bg-light-purple mb-0 p-3 ml-3" style="border-radius:5px 5px 0px 0px;">
                    <div class="row justify-content-between mb-0 ml-0">
                        ...
                        <div class="col-md-8 align-self-center">
                            <label class="text-truncate SemiBold mb-0" 
