...
<div class="card shadow mb-2" style="border-radius: 10px;">
    ...
    <form id="favorit-form" action="{{ route('favorit.status',$p->id_produk) }}" method="POST">
        @csrf
        {{-- <label class="switch"> --}}
        {{-- <input id="statusFavorit" class="statusFavorit" type="checkbox" value="{{$p->id_produk}}"
        name="status_favorit" onchange="event.preventDefault(); document.getElementById('favorit-form').submit();"
        checked hidden> --}}
        {{-- </label> --}}
