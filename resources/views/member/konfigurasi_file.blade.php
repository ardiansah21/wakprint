    ...
    <div class="mt-5 mb-5">
        ...
        <div class="row justify-content-between mr-0 mb-5">
            ...
            <div class="col-md-6 mt-5 ml-0 mr-0">
                <div class="row justify-content-between bg-light-purple pl-4 pr-4 pt-4 pb-4 mb-4"
                    style="border-radius:5px;
                        height:310px;">
                    <div class="col-md-6 border-primary-purple d-flex h-100"
                        style="width:265px; 
                            height:265px;">
                    ...
                    <div class="col-md-6">
                        <label class="text-justify mb-4 ml-2"
