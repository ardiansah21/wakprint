        ...
        <div class="row justify-content-between mb-5 mt-5">
            ...
            <div class="col-md-8 ml-0">
                ...
                <div class="row mb-3">
                    <div class="col-md-9">
                        <div class="search-input mb-3">
                            <div class="main-search-input-item">
                                ...
                                <input id="keyword" name="keyword" type="text" role="search" class="form-control" value="" autofocus onfocus="this.value = this.value;"
                                @php
                                ...
                                @endphp
                                    ...
                                    border-radius:30px;
                                    font-size:18px;"
                                    onkeyup="event.preventDefault(); document.getElementById('search-form').submit();">
                                <i class="material-icons pointer ml-1 pt-1 pb-1 pl-3 pr-3" style="position: absolute;
                                    top: 50%;
                                    left: 95%;
                                    transform:translate(-50%, -50%);
                                    -ms-transform: translate(-50%, -50%);" onclick="event.preventDefault(); document.getElementById('search-form').submit();">
                                    search
                                </i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="dropdown">
                            <input name="filter_pencarian" type="text" id="filter_pencarian" Class="form-control" hidden>
                            <button id="filterPencarianButton"
                                class="is-flex btn btn-default btn-lg btn-block shadow-sm dropdown-toggle border border-gray"
                                id="dropdownFilterPencarian" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 16px;
                                    text-align:left;">
                                {{__('Urutkan') }}
                            </button>
                            @php
                            ...
                            @endphp
                            <div id="filterPencarianList" class="dropdown-menu" aria-labelledby="dropdownFilterPencarian"
                                style="font-size: 16px; width:100%;">
                                                ...
                                                <a class="text-decoration-none" href="partner/detail/{{ $p->id_pengelola }}"
                                                    ...
                                                    <div class="card-footer card-footer-primary"
                                                        ...
                                                        <div class="row justify-content-between ml-0">
                                                            ...
                                                            <label class="card-text mr-4 font-weight-bold"
                                                                style="font-size: 18px;">
                                                                <i class="material-icons md-24 mr-1 align-middle"
                                                                    style="color: #FCFF82">star</i>
                                                                {{$p->rating_toko}}
...
@section('script')
    <script>
        ...
        //     cardContainer = document.getElementById("pencarianItems");
