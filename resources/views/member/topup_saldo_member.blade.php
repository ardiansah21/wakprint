            ...
            <div class="container col-4 mt-5 ml-0">
                ...
                <div class="mt-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="mt-3">
                            <a class="nav-link active font-weight-bold mb-2" id="v-pills-saldo-tab" onclick="window.location='{{ url('/member/saldo/topup') }}'" data-toggle="pill" href="#v-pills-saldo" role="tab" aria-controls="v-pills-saldo" aria-selected="false"><i class="material-icons align-middle md-32 mr-2">account_balance_wallet</i>Rp. 12.000</a>
            ...
            <div class="container col-8 mt-5">
                ...
                <div class="container bg-primary-yellow p-4 ml-1 mb-5" style="border-radius:5px;">
                    ...
                    <div class="input-group mb-4">
                        <input type="text" class="form-control form-control-lg form-control-yellow pt-2 pb-2" placeholder="Contoh : 1.000.000" 
                        aria-label="Contoh : 1.000.000" aria-describedby="inputGroup-sizing-sm" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                    </div>

                    <div class="container pl-0 pr-0 mb-4">
                        <button type="button" class="btn btn-primary-wakprint btn-lg btn-block font-weight-bold" style="border-radius:30px"><i class="material-icons md-36 align-middle mr-3">upgrade</i> Top Up</button>
                    </div>
