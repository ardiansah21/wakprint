                ...
                <div class="row justify-content-between bg-light-purple p-3" style="border-radius:10px;">
                    ...
                    <div class="row justify-content-left mb-5">
                        <span class="align-self-center col-md-1 mr-0">
                            ...
                            <!--Carousel Wrapper-->
                        <div id="multi-item-foto-percetakan" class="carousel slide carousel-multi-item col-md-8" data-ride="carousel">
            ...
            <div class="col-md-8 mt-5">
                <div class="search-input mr-0 ml-3 mb-4">
                    <div class="main-search-input-item mr-0">
                        <input id="keyword" type="text" role="search" class="form-control" placeholder="Cari produk disini" aria-label="Cari produk disini" aria-describedby="basic-addon2" style="border:0px solid white; border-radius:30px; font-size:18px;">
                            <i id="cari" class="material-icons cursor-pointer ml-1 pt-1 pb-1 pl-3 pr-3" style="position: absolute; top: 50%; left: 95%; transform: translate(-50%, -50%); -ms-transform: translate(-50%, -50%);">
                                search
                            </i>
                    </div>
                </div>
                <div class="row justify-content-between mb-4 ml-0">
                    <div class="col-md-3">
                        <div class="btn-group btn-group-toggle mb-4" data-toggle="buttons">
                            <label id="semua" class="btn btn-yellow-wakprint btn-outline-black mr-1 pt-1 pb-1 pl-4 pr-4" style="border-radius:30px; font-size:18px;">
                        ...
                        <div class="dropdown">
                            ...
                            <button id="filterProdukButton" class="is-flex btn btn-default btn-lg shadow-sm dropdown-toggle border border-gray" id="dropdownFilterProduk" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 16px; text-align:left;">
                                {{__('Urutkan') }}
                            </button>
                            @php
                                $filterProduk= array('Terbaru', 'Harga Tertinggi', 'Harga Terendah');
                            @endphp
                            <div id="filterProdukList" class="dropdown-menu" aria-labelledby="dropdownKertas" style="font-size: 16px; width:100%;">
                    ...
                    @php
                        $ukuranKertas= array('A4HVS70gr', 'A4HVS80gr', 'A3HVS70gr', 'A3HVS80gr', 'F4HVS70gr', 'F4HVS80gr', 'LegalHVS70gr', 'LegalHVS80gr', 'LetterHVS70gr', 'LetterHVS80gr');
                    @endphp
                    <div class="col-md-9">
                        <div class="scrolling-wrapper mb-2 ml-0 mr-0">
                            <div class="btn-group btn-group-toggle pb-2"
                                ...
                                @foreach ($ukuranKertas as $key =>$kertas)
                                    <label class="btn btn-yellow-wakprint btn-outline-black ml-1 mr-1 pt-1 pb-1 pl-4 pr-4" style="border-radius:30px; font-size:18px;">
                                        <input id="jenisKertas{{$key}}" type="checkbox" checked autocomplete="off" value="{{$kertas}}">
                                            {{$kertas}}
                                    </label>
                                @endforeach
                            </div>
                        ...
                        <div class="scrolling-wrapper">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                @foreach ($jenisPrinter as $key => $printer)
                                    <label class="btn btn-yellow-wakprint btn-outline-black ml-1 mr-1 pt-1 pb-1 pl-4 pr-4" style="border-radius:30px; font-size:18px;">
                                        <input id="jenisPrinter{{$key}}" type="checkbox" checked autocomplete="off" value="{{$printer}}">
                                            {{$printer}}
                                    </label>
                                @endforeach
                            </div>
        ...
        function searching() {
            ...
            $.ajax({
                ...
                beforeSend:function(){
                    ...
                    $('.produk').html('<div class="mx-auto"><img id="imgLoading" style="" src="/img/loading.gif" /></div>');
                },
                ...
                success:function(produks) {
                    var produkItem = '<div class="row justify-content-between ml-0 mr-0">';
                        if (produks['produks'].length != 0) {
                            ...
                            produkItem +='<label class="text-primary-purple font-weight-bold ml-3" style="font-size: 18px; min-height:65px;">Data yang Anda Cari Tidak Ada</label>';
                        }
                    produkItem +='</div>';
