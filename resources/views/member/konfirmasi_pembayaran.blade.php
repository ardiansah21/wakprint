...
@section('content')
    <div class="container mb-5 mt-5">
        <div>
                        ...
                        <div class="card pt-2 pb-2 pl-4 pr-4 mb-5" style="width:370px; min-height:120px;font-size:18px;">
                            <p class="mb-2">
                                {{ __('Lorem ipsum dolor, sit amet consectetur adipisicing elit. Pariatur quam
                                            veritatis recusandae provident voluptatem quos optio accusamus molestiae saepe iusto
            ...
            <div class="bg-light-purple p-4 mb-5" style="border-radius:10px; font-size:18px;">
        ...
        <div class="row justify-content-end mb-5 mr-0">
            <button class="btn btn-outline-danger-primary btn-lg text-primary-danger font-weight-bold mr-4" style="border-radius:30px;
                                      font-size:24px;">
                {{ __('Batalkan Pemesanan') }}
            </button>
            <button class="btn btn-primary-wakprint btn-lg font-weight-bold pl-4 pr-4" style="border-radius:30px;
                                      font-size:24px;">
