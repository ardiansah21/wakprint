        ...
        <form action="{{ route('partner.atk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-10">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 form-group mb-4">
                            <input id="jumlah" type="number" name="jumlah" min="0"
            ...
            <div class="row justify-content-end ml-0 mr-0 mb-5">
                ...
                <div class="form-group mr-0">
                    <button
                        type="submit"
                        class="btn btn-lg btn-primary-wakprint font-weight-bold pl-5 pr-5 mb-0"
                        style="border-radius:30px;">
                        {{__('Tambah') }}
                    </button>
                </div>
                ...
                <div class="row justify-content-between mb-2 ml-0" style="list-style-position: inside">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group mb-4 mr-0">
                            <textarea id="deskripsi" name="deskripsi" class="form-control d-flex"
                                aria-label="Deskripsi Atk" placeholder="Masukkan Deskripsi Atk Tambahan Anda"></textarea>
                        </div>
                    </div>
