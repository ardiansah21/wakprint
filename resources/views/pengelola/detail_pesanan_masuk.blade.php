...
@section('content')
    <div class="container mt-5 mb-5">
        ...
        <div class="border-primary-purple mb-5" style="border-radius: 10px;">
            <div class="row justify-content-between bg-light-purple ml-0 mr-0 p-2"
                style="width: 100%; border-bottom: 1px solid #BC41BE; border-radius: 10px 10px 0px 0px;">
            ...
            <div class="pl-4 pr-4 pt-3 pb-3">
                <div class="pb-2 mb-4" style="border-bottom: 1px solid #EBD1EC">
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="text-right">
                            <div class="container mb-3">
                                <button type="button" class="btn btn-primary-yellow font-weight-bold pl-5 pr-5 mb-0" style="border-radius:30px;
                                        font-size:16px;">
                                    {{ __('Cetak') }}
                                </button>
                            </div>
            ...
            <div class="text-right mr-0">
                <div class="container mb-3">
                    <button class="btn btn-outline-danger-primary text-primary-danger font-weight-bold pl-5 pr-5 mb-0"
                        data-toggle="modal" data-target="#tolakPesananModal" style="border-radius:30px;
                            font-size:18px;">
                        {{ __('Tolak') }}
                    </button>
                </div>
