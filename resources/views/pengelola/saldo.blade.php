    ...
    <div class="row justify-content-between mb-4 ml-0 mr-0">
        <div class="col-md-auto form-group">
            ...
            <div class="dropdown" aria-required="true">
                <input name="jenisdana" type="text" id="jenisdana" Class="form-control" hidden>
    ...
    <div class="table-scrollbar mb-4 ml-0 pr-2">
        <table class="table table-hover">
            ...
            <tbody style="font-size:12px;">
                ...
                @if ($ts->jenis_transaksi === 'Tarik' && $ts->id_pengelola === $partner->id_pengelola)
                <tr>
