...
<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical"
    style="font-size: 18px;">
    <a class="nav-link active mb-2" id="v-pills-beranda-tab" data-toggle="pill" href="#v-pills-beranda" role="tab"
    ...
    <a class="nav-link mb-2" id="v-pills-pesanan-tab" data-toggle="pill" href="#v-pills-pesanan" role="tab"
    ...
    <a class="nav-link mb-2" id="v-pills-produk-tab" data-toggle="pill" href="#v-pills-produk" role="tab"
    ...
    <a class="nav-link mb-2" id="v-pills-promo-tab" data-toggle="pill" href="#v-pills-promo" role="tab"
    ...
    <a class="nav-link mb-2" id="v-pills-atk-tab" data-toggle="pill" href="#v-pills-atk" role="tab"
    ...
    <a class="nav-link mb-2" id="v-pills-info-tab" data-toggle="pill" href="#v-pills-info" role="tab"
    ...
    <a class="nav-link mb-2 mt-4" id="v-pills-keluar-tab" data-toggle="pill" href="#v-pills-keluar" role="tab"
