        ...
        <div class="container-fluid pt-5 pb-5" style="margin-top:72px">
            ...
            <form class="needs-validation" novalidate>
                <div class="container mb-4">
                    ...
                    <small><p class="mb-5 text-right"><a class="text-primary-purple" href="{{ url('http://www.wakprint.com/') }}">Lupa Kata Sandi ?</a></p></small>
    
                    <button type="submit" class="btn btn-primary-wakprint btn-lg btn-block font-weight-bold mb-0" onclick="window.location='{{ url('/pengelola') }}'">Masuk</button>
                </div>
            </form>

            <div class="container mb-5">
                <p class="mb-4 text-center">Belum punya akun ? <a class="text-primary-purple" href="{{ url('/pengelola/register') }}">Daftar</a></p>
            </div>
        </div>
    </div>
@endsection
