...
<div class="tab-pane fade show active" id="v-pills-beranda" role="tabpanel">
    <div class="row justify-content-left mb-0 ml-0 mr-0">
        ...
        <div class="my-auto">
            <button class="btn btn-sm btn-danger bg-primary-danger font-weight-bold pl-4 pr-4" onclick="window.location.href='https://mail.google.com/'" style="border-radius:30px; font-size:16px;">
                {{__('Laporkan')}}
            </button>
        </div>
    </div>
