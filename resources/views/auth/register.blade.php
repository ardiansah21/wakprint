...
<form method="POST" action="{{ route('register') }}" style="font-size: 24px;">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nama" class="form-control form-control-lg mb-3" placeholder="Masukkan Nama Lengkap"
            required autofocus>
    </div>
    <div class="form-group">
        <label for="nomor_hp" class="mb-2">{{__('nomor_hp')}}</label>
        <input type="text" name="nomor_hp" class="form-control form-control-lg mb-3" placeholder="wakprint@gmail.com"
            required autofocus>
    </div>
    <div class="form-group">
        <label for="nomor_hp" class="mb-2">{{__('Nomor HP')}}</label>
        <input type="tel" name="nomor_hp" class="form-control form-control-lg mb-3" placeholder="Masukkan Nomor HP Anda"
            required autofocus>
    </div>
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            <input type="password" name="password" class="form-control form-control-lg"
                placeholder="Masukkan Kata Sandi" data-toggle="password" required autofocus>
    ...
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            <input required type="password" name="confirm-password" class="form-control form-control-lg"
                placeholder="Konfirmasi Kata Sandi" data-toggle="password">
            <div class="input-group-append">
                <span class="input-group-text bg-white" style="border-radius: 0px 5px 5px 0px;">
                    <i id="togglePassword" toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password">
                    </i>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-primary-wakprint btn-lg btn-block SemiBold" style="font-size: 24px;">
            {{__('Daftar')}}
        </button>
    </div>
</form>
