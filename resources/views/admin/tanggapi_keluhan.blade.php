...
{{-- <div class="modal fade" id="keluhanModal" tabindex="-1" role="dialog"
    aria-labelledby="keluhanModalLabel" aria-hidden="true">
                ...
                <div class="mb-0">
                    ...
                    <div class="row justify-content-left mb-3 mr-0">
                        <div class="col-md-1 align-self-center ml-0 mr-2">
                            <img src="https://ptetutorials.com/images/user-profile.png" width="32" height="32"
                                alt="no logo">
                        </div>
                        <div class="col-md-10 ml-0 mr-0">
                    ...
                    <div class="form-group mb-5">
                        <textarea type="text" class="form-control form-control-lg pt-2 pb-2"
