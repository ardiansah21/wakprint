                ...
                <div class="col-4 mt-5">
                    <div>
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active mb-4" id="v-pills-keluhan-tab" data-toggle="pill" onclick="window.location='{{ url('/admin/keluhan') }}'" href="#v-pills-keluhan" role="tab" aria-controls="v-pills-keluhan" aria-selected="true" style="font-size: 24px;">
