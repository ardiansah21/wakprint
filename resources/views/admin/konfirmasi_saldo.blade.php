...
@section('content')
    <div class="tab-pane fade show active" role="tabpanel" style="font-size: 18px;">
        {{-- <div class="row jusify-content-between mb-3 mr-0">
            <div class="col-md-10">
                <div class="form-group search-input">
                    <div class="main-search-input-item">
                        <input type="text" role="search" class="form-control" placeholder="Cari data saldo disini..."
                            aria-label="Cari data saldo disini" aria-describedby="basic-addon2"
            ...
            <div class="col-md-2">
                <div class="dropdown">
                    <button class="btn btn-default btn-lg shadow-sm dropdown-toggle border border-gray" id="filterDataSaldo"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 16px;">
                        {{ __('Semua') }}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="filterDataSaldo" style="font-size: 16px;">
        ...
        <div class="ml-0 mr-0">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="font-size: 16px;">
                <li class="nav-item mr-3">
                    <a class="nav-link active" id="pills-saldo-member-tab" data-toggle="tab" href="#pills-saldo-member"
                        role="tab" aria-controls="pills-saldo-member" aria-selected="true"
            ...
            <div class="tab-content ml-0 mr-0" id="pills-tabContent">
                                    ...
                                    @foreach ($transaksi_saldo as $ts)
                                        @if ($ts->jenis_transaksi === 'TopUp' || $ts->jenis_transaksi === 'Pembayaran')
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="">
                                                        <i class="material-icons" style="color: #7BD6AF;">
                                                            check_circle
                                                        </i>
                                                    </a>
                                                    <a href="{{ route('admin.saldo.tolak') }}">
                                                        <i class="material-icons" style="color: #FF4949;">
                                                            cancel
                                                        </i>
                                                    </a>
                                                </td>
                ...
                <div class="tab-pane fade" id="pills-saldo-pengelola" role="tabpanel"
