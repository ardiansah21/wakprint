...
self.PusherPushNotifications = {
    ...
    _hasVisibleClient: function _hasVisibleClient() {
        return self.PusherPushNotifications._getVisibleClient().then(function(
            client
        ) {
    ...
    _hasFocusedClient: function _hasFocusedClient() {
        return self.PusherPushNotifications._getFocusedClient().then(function(
            client
        ) {
            return client !== undefined;
        });
                        ...
                        while (1) {
                            switch ((_context.prev = _context.next)) {
                                ...
                                case 18:
                                    ...
                                    path = ""
                                        .concat(
                                            self.PusherPushNotifications._endpoint(
                                                instanceId
                                            ),
        ...
        (function() {
            var _ref2 = asyncToGenerator(
                ...
                regenerator.mark(function _callee2(payloadFromCallback) {
                    var hideNotificationIfSiteHasFocus,
                        title,
                        body,
                        icon,
                        options;
                            ...
                            switch ((_context2.prev = _context2.next)) {
                                ...
                                case 8:
                                    title =
                                        ...
                                        .title || "";
                                    body =
                                        payloadFromCallback.notification.body ||
                                        "";
                                    icon =
                                        payloadFromCallback.notification.icon;
                                    options = {
                                        body: body,
                                        icon: icon,
                                        data: {
...
self.addEventListener("notificationclick", function(e) {
    ...
    if (isPusherNotification) {
        ...
        if (pusher.customerPayload.notification.deep_link) {
            e.waitUntil(
                clients.openWindow(
                    pusher.customerPayload.notification.deep_link
                )
            );
        }
